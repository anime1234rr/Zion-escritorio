...
const GRUPOS: { titulo: string; atajos: Atajo[] }[] = [
  {
    ...
    atajos: [
      {
        combinacion: 'Ctrl + K',
        descripcion: 'Abrir el buscador rápido para saltar a un servidor, canal o persona.',
      },
    ],
  },
  {
  ...
  },
  {
    titulo: 'Voz',
    atajos: [
      { combinacion: 'Ctrl + Shift + M', descripcion: 'Silenciar o activar tu micrófono.' },
      { combinacion: 'Ctrl + Shift + D', descripcion: 'Ensordecer o volver a escuchar.' },
    ],
  },
  {
